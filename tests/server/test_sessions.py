...
class TestSessionManager(unittest.TestCase):
    ...
    def test_create_session_runs_workflow_in_background_and_completes(self):
        def fake_run_workflow(user_request, interactive, agent_mode, auto_approve, session_id, server_mode=False, workspace=None):
    ...
    def test_create_session_returns_immediately_without_blocking(self):
        ...
        def slow_run_workflow(user_request, interactive, agent_mode, auto_approve, session_id, server_mode=False, workspace=None):
            time.sleep(0.5)
    ...
    def test_workflow_exception_marks_session_as_error(self):
        def broken_run_workflow(user_request, interactive, agent_mode, auto_approve, session_id, server_mode=False, workspace=None):
